      ...
      child: Scaffold(
        appBar: AppBar(
          iconTheme: IconThemeData(
              color: themeProvider.appTheme == ThemeMode.dark ? AppColors
                  .primaryColor :
              AppColors.blackColor),
          backgroundColor: themeProvider.appTheme == ThemeMode.dark ? AppColors
              .darkPrimary : AppColors.whiteBgColor,
          centerTitle: true,
          title: Text(AppLocalizations.of(context)!.register,
              style: themeProvider.appTheme == ThemeMode.dark ? AppStyles
                  .med16white : AppStyles.med16black),
        ),
        body: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        CustomTextFormField(
                          ...
                          prefixIcon:
                          Image(image: AssetImage(AppAssets.nameIcon)),
                          controller: nameController,
                          kerboardType: TextInputType.text,
                          borderSideColor: themeProvider.appTheme ==
                              ThemeMode.light ? AppColors.greyColor : AppColors
                              .primaryColor,
                          validator: (text) {
                            if (text == null || text
                                .trim()
                        ...
                        CustomTextFormField(
                          ...
                          prefixIcon: Image(image: AssetImage(AppAssets
                              .passwordIcon)),
                          ...
                          }, icon: Icon(obscure ? Icons.visibility_off : Icons
                              .visibility,
                        ...
                        CustomTextFormField(
                          ...
                          validator: (text) {
                            ...
                            if (text.length < 6) {
                              return AppLocalizations.of(context)!
                                  .enter_valid_re_password;
                            }
                            if (rePasswordController.text != passwordController
                                .text) {
                              return AppLocalizations.of(context)!
                                  .pass_should_equal_repass;
                            }
                            return null;
                          },
                          prefixIcon: Image(image: AssetImage(AppAssets
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        color: languageProvider.appLanguage ==
                                            'en'
