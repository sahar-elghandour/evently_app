...
class AppStyles {
  ...
  static TextStyle reg14white = GoogleFonts.inter(
      fontSize: 14,
      fontWeight: FontWeight.normal,
      color: AppColors.whiteColor
  );
  static TextStyle reg16white = GoogleFonts.inter(
      fontSize: 16,
      fontWeight: FontWeight.normal,
      color: AppColors.whiteColor
  );
  static TextStyle med16red= GoogleFonts.inter(
      fontSize: 16,
      fontWeight: FontWeight.w500,
  ...
  static TextStyle reg36primary = GoogleFonts.inter(
      fontSize: 36,
      fontWeight: FontWeight.normal,
      color: AppColors.primaryColor
  );
